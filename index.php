...
<html>
	...
	<title>Brijal Savaliya | Full Stack Developer</title>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="border js-fullheight">
			<div class="text-center">
				...
				<h1 id="colorlib-logo"><a href="index.html">Brijal Savaliya</a></h1>
				<span class="position"><a href="#">Full Stack Developer</a> in Canada</span>
			</div>
			<nav id="colorlib-main-menu" role="navigation" class="navbar">
				<div id="navbar" class="collapse">
					<ul>
						...
						<li><a href="#" data-nav-section="services">Responsibilities</a></li>
			...
			<div class="colorlib-footer">
				<ul>
					<li><a href="https://github.com/brijal1987"><i class="icon-github"></i></a></li>
					<li><a href="https://www.linkedin.com/in/brijal-savaliya-69743512/"><i class="icon-linkedin2"></i></a></li>
					<li><a href="https://www.facebook.com/brijal.savaliya"><i class="icon-facebook2"></i></a></li>
					<li><a href="https://twitter.com/brij0412"><i class="icon-twitter2"></i></a></li>
					<li><a href="https://www.instagram.com/brijal.savaliya"><i class="icon-instagram"></i></a></li>
				</ul>
			</div>
		...
		<div id="colorlib-main">
						...
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
									<div class="hire">
										<h2>I am happy to know you <br>that 50+ projects done sucessfully!</h2>
										<a href="mailto:brijal.savaliya@gmail.com?subject=Hire me" class="btn-hire">Hire me</a>
									</div>
								</div>
							</div>
						</div>
			...
			<section class="colorlib-about" data-section="services">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-12">
							<div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
								<div class="col-md-12">
									<div class="about-desc">
										...
										<h2 class="colorlib-heading">Responsibilities</h2>
										<ul class="responsibility">
											<li>✓ Assist in the development of strategies, roadmaps, reference architectures and application performance analysis</li>
											<li>✓ Served the role of Team/Project Lead and IT Architect to support and deliver services to organization</li>
											<li>✓ Plan, coordinate, analyze, design, and lead the implementation of technical solutions and/or enhancements to existing systems to meet current and future needs</li>
											<li>✓ Provide leadership in the development of, and adherence to, all technical standards, infrastructure portfolio strategy, service level agreements, and infrastructure processes</li>
											<li>✓ Participate in the design review process and support the overall PMO Architecture Design process. Performs proactive systems performance analysis and tuning</li>
											<li>✓ Worked on large scale projects from Architecture and system design to implementation and Contribute to Continuous Improvement initiatives to improve architecture processes</li>
											<li>✓ Experienced in all project phases using Waterfall and Agile/Scrum Methodologies.</li>
											<li>✓ Able to organize and run meetings, leaving with clear objectives and tasks</li>
											<li>✓ Comfortable talking with clients (via Slack, Skype, phone, email, GTM and in person)</li>
											<li>✓ Exceptional analytical skills, An excellent communicator and collaborator, Strong interpersonal skills, Keen ability to multi-task, self-starter and Capable of hitting daily deadlines</li>
										</ul>
									</div>
								</div>
							</div>
									...
									<div class="panel panel-default">
									    <div class="panel-heading" role="tab" id="headingOne">
									        <h4 class="panel-title">
									            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Bachelor Degree in Information Technology
									            </a>
									        </h4>
									    </div>
									    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
									         <div class="panel-body">
												<p>Completed B.E. in Information Technology in the year 2009 from Vishwakarma government engineering college with 60%.</p>
									         </div>
									    </div>
									</div>
									<div class="panel panel-default">
									    <div class="panel-heading" role="tab" id="headingTwo">
									        <h4 class="panel-title">
									            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Higher Secondary
									            </a>
									        </h4>
									    </div>
									    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									        <div class="panel-body">
									            <p>Completed Intermediate (XII) from Sardar Patel Vidhyalaya, Surendranagar from Gujarat Secondary and Higher Secondary Education Board with 70% in the year 2005.</p>
									        </div>
									    </div>
									</div>
									<div class="panel panel-default">
									    ...
									    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
									        <div class="panel-body">
									            <p>Completed High School (X) from JNV Vidhyalaya, Surendranagar from Gujarat Secondary and Higher Secondary Education Board with 78% in the year 2003.</p>	
									        </div>
									    </div>
									</div>
								</div>
						 ...
						 <article class="timeline-entry animate-box" data-animate-effect="fadeInLeft">
					         ...
					         <article class="timeline-entry animate-box" data-animate-effect="fadeInLeft">
					            <div class="timeline-entry-inner">
					               ...
					               <div class="timeline-label">
									   <h2><a href="#">Senior Software Developer</a> <span>November 2009 - December 2017</span></h2>
									   <h5>Sparsh Technologies - Ahmedabad, India</h5>
						...
						<div class="col-md-12">
							<div class="colorlib-feature colorlib-feature-sm animate-box" data-animate-effect="fadeInLeft">
								...
								<div class="colorlib-text">
									<p><a href="mailto:brijal.savaliya@gmail.com">brijal.savaliya@gmail.com</a></p>
								</div>
							</div>
